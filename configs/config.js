...
module.exports =
{
    ...
    location_index:
    {
        ...
        'tj': {eng: 'Tianjin',chn: '天津',prov:'天津',index_city:'tj'},
        'sh': {eng: 'Shanghai', chn: '上海',prov:'上海',index_city:'sh'},
        'gz': {eng: 'Guangzhou', chn: '广州',prov:'广东',index_city:'gz'},
        'sz': {eng: 'Shenzhen', chn: '深圳',prov:'广东',index_city:'sz'}
    }
};